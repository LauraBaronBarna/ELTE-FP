-- We dont use the division symbol, to divide we use number `div` number
-- mod divides (??)
--main = print (1 == 2) -- Prints 



-- x :: Int   --Defining the type of variable  
-- x = 4 -- Asigning a variable

-- s :: String
-- s = "Hello"

-- add :: Int -> Int -> Int -- Function declaration
-- add x y = x + y --Defining parameters
